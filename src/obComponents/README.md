...
// parsed.isTask === true
// parsed.taskStatus === TaskStatus.Done
// parsed.startTime === { hour: 10, minute: 30 }
// parsed.dates[0].date === "2023-09-15"
// parsed.content === "Complete project report"
```
...
// event.start === 2023-09-10T14:00:00
// event.end === 2023-09-10T15:30:00
// event.eventType === "TASK-TODO"
```
